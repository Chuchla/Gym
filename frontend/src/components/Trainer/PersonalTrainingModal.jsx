          ...
          {eventType === "single" ? (
            ...
            <>
              ...
              <div className="form-group">
                ...
                <input type="date" name="start_repeat" value={formData.start_repeat} onChange={handleChange} required />
              </div>
              <div className="form-group">
                <label>End Date</label>
                <input type="date" name="end_repeat" value={formData.end_repeat} onChange={handleChange} required />
              </div>
            </>
          )}
